...
const TextHeader = () => {
  return (
    <div className="w-full flex TextHeaderCont  opacity-0 items-center fixed bottom-2 left-0 justify-between px-10 py-6 z-100">
      ...
      {/* Left — 50% */}
      <div className="text-[#5a3823] text-[18px] max-sm:text-sm font-serif">
        50%
      </div>

      {/* Center — Menu */}
      <div className="flex  flex-col items-center absolute left-1/2 -translate-x-1/2 text-[#b69d8d] font-serif italic max-sm:text-[0.6rem] text-[15px]">
      ...
      <div className="flex w-fit h-fit gap-2 m-auto">
        ...
        {/* Right — [+ | -] */}
      <div className="font-serif text-[#5a3823] text-[18px] max-sm:text-sm select-none cursor-pointer">
        [ + | - ]
      </div>
      </div>
